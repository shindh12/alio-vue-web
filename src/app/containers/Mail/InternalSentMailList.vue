            ...
            <div class="table-area">
                ...
                <div class="table__action">
                    <div class="table__action__default">
                        ...
                        <!-- <v-btn @click.native="openInternalMailWritePopup()">{{ message['compose'] }}</v-btn> -->
                    </div>
                </div>
                ...
                <div class="table__body">
                    ...
                    >
                        ...
                        <template slot="items" slot-scope="props">
                            <tr>
                                <td v-clickable class="text-xs-left" @click="openExternalMailDialog(props.item.mailId)"> {{ props.item.mailSubject }}</td>
...
<script>
    ...
    export default {
        ...
        computed: {
            ...
            currentMailAddress() {
                return this.$store.state.loginStore.currentUser.email;
            },
            currentid() {
                return this.$store.state.loginStore.currentUser.userId;
            },
            datetimePattern() {
        ...
        methods: {
            ...
            openInternalMailWritePopup() {
                let routeData = this.$router.resolve({path: '/pop/mail'});
                window.open(routeData.href, 'Mail', 'width=800,height=750');
            },
            ...
            getGridHeader() {
                let newHeaders = [
                    ...
                    {text: this.message['recipient-status'], align: 'center', sortable: false, value: 'status', width: '180px'},
