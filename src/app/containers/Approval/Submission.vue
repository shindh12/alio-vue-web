<template>
    <div class="isdp-body-content">
            ...
            <div class="page-searchbox__row">
                ...
                <div class="page-searchbox__item-cell">
                    <v-text-field name="searchApprovalUser" :label="message['current-approval-user']"
                                  :placeholder="'\''+message['username'] + '\' ' + this.message['or'] + ' \'' + message['id']+ '\''" v-model.trim="searchCondition.approvalUserText"
                                  @keyup.13="callbackPagination(1)" maxlength="30"></v-text-field>
                </div>
            </div>
            ...
            <div class="table-area">
                ...
                <div class="table__action">
                    <div class="table__action__default">
                        <v-btn @click.native="openCreateDialog()">{{ message['create-approval'] }}</v-btn>
                    </div>
                </div>
                        ...
                        <template slot="items" slot-scope="props">
                            <tr>
                                ...
                                <td class="justify-center layout px-0">
                                    <v-btn v-if="props.item.statusCode != 'CANCEL'
                            && props.item.statusCode != 'COMPLETE'
                            && props.item.statusCode != 'DISAPPROVAL'"
                                           icon class="mx-0"
                                           @click.stop="openConfirmCancelDialog(props.item)"
                                    ><!-- cancelApproval(props.item)"-->
        ...
        <!-- Create Dialog Area -->
        <internal-approval-dialog :showDialog="createDialog" @closeDialog="closeCreateDialog"></internal-approval-dialog>
...
<script>
    ...
    import InternalApprovalDialog from './ApprovalDialog/InternalApprovalDialog';
    ...
    export default {
        ...
        methods: {
            movePage(index) {
                ...
                axios.get('/rest/v1/approval/i/submission', {params: parameter})
                .then(response => {
            ...
            cancelApproval(approval) {
                axios.post('/rest/v1/approval/i/cancel', approval)
                .then(response => {
