                ...
                <div class="page-searchbox__item-cell page-searchbox__item-cell--datepicker-comboset page-searchbox__item-cell--colspan2">
                    ...
                    <div class="page-searchbox__item-cell--datepicker-comboset__wrapper">
                        <v-menu
                            ...
                            <v-date-picker v-model.trim="searchCondition.fromSubmissionDateText" no-title @input="datepicker1 = false" />
                        </v-menu>
                        <v-menu
                            ref="datepicker2"
                            :close-on-content-click="false"
    ...
    export default {
        ...
        methods: {
            movePage(index) {
                ...
                axios.get('/rest/v1/approval/i/approved', {params: parameter})
                .then(response => {
